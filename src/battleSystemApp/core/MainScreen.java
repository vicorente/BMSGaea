...
/**
 * Demonstrates how to create and display World Wind tactical symbols. See the
 * <a title="Symbology Usage Guide"
 * href="http://goworldwind.org/developers-guide/symbology/"
 * target="_blank">Symbology Usage Guide</a> for more information on symbology
 * support in World Wind.
 * <p/>
 * See the {@link TacticalGraphics} for a detailed example of using World Wind
 * tactical graphics in an application.
 * 
 * @author dcollins
 * @version $Id: TacticalSymbols.java 1171 2013-02-11 21:45:02Z dcollins $
 */
public class MainScreen extends ApplicationTemplate {
	public static class AppFrame extends ApplicationTemplate.AppFrame {
		...
		public AppFrame() {
			...
			// symbols and tactical graphics can be combined
			...
			TacticalSymbol airSymbol = new MilStd2525TacticalSymbol(
					"SFAPMFQM--GIUSA", Position.fromDegrees(32.4520, 63.44553,
							3000));
			...
			// Size the World Window to provide enough screen space for the
			// symbols and center the World Window on the
			// screen.
