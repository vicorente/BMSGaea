...
/**
 * Controla los componentes del InterfaceLayer personalizado
 */
public class InterfaceLayerSelectListener implements SelectListener
{
    protected static final int DEFAULT_TIMER_DELAY = 50;

    protected WorldWindow wwd;
    protected InterfaceLayer viewControlsLayer;
     ...
     */
    public InterfaceLayerSelectListener(WorldWindow wwd, InterfaceLayer layer)
    {
        if (wwd == null)
        {
