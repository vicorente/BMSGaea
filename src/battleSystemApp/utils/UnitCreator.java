 ...
 */
public class UnitCreator extends WWObjectImpl
    implements SelectListener, MouseListener, MouseMotionListener, RenderingListener
{
    ...
    public UnitCreator(WorldWindow worldWindow)
    {
        if (worldWindow == null)
        {
    ...
    protected UnitCreator(WorldWindow worldWindow, RegionShape shape, RenderableLayer rLayer)
    {
        if (worldWindow == null)
        {
            String msg = Logging.getMessage("nullValue.WorldWindow");
