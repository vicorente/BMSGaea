 ...
 */
public class BasicScrollFrameAttributes implements ScrollFrameAttributes
{
    ...
    public BasicScrollFrameAttributes()
    {
     ...
     */
    public BasicScrollFrameAttributes(ScrollFrameAttributes attributes)
    {
        if (attributes == null)
        {
    ...
    /** {@inheritDoc} */
    public BasicScrollFrameAttributes copy()
    {
        return new BasicScrollFrameAttributes(this);
    }

    /** {@inheritDoc} */
    public void copy(ScrollFrameAttributes attributes)
    {
        if (attributes != null)
        {
    ...
    public boolean equals(Object o)
    {
        ...
        BasicScrollFrameAttributes that = (BasicScrollFrameAttributes) o;
